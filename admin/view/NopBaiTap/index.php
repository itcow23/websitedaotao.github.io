                            ...
                            <div class="card">
                                ...
                                <div class="container">
                                    ...
                                    <?php foreach($arr as $each): ?>
                                        <tr>
                                            <td><?php echo $each->get_maNopBaiTap() ?></td>
                                            <td><?php echo $each->get_tenLop() ?></td>
                                            <td><?php echo $each->get_tenKhoaHoc() ?></td>
                                            <td><?php echo $each->get_tenBaiHoc() ?></td>
                                            <td><?php echo $each->get_tenUser() ?></td>
                                            <td><?php echo $each->get_ngayNop() ?></td>
                                            <td><?php echo $each->get_fileNop() ?></td>
                                           
                                            <td>
                                                <a href="?action=delete&controller=nopbaitap&maNopBaiTap=<?php echo $each->get_maNopBaiTap() ?>" class="btn btn-danger">
                                                    Xoá
                                                </a>
                                            </td>
                                        </tr>
