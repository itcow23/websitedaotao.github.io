        ...
        <div class="left-side-menu">
            ...
            <div class="h-100" id="left-side-menu-container" data-simplebar>
                ...
                <ul class="metismenu side-nav">
                    ...
                    <li class="side-nav-item">
                        <a href="index.php?controller=khoahoc" class="side-nav-link">
                                ...
                                <div class="container">
                                    ...
                                    <?php foreach($arr as $each): ?>
                                        <tr>
                                            ...
                                            <td><?php echo $each->get_thoiGian()  ?></td>
                                            <td>
                                            <?php 
                                                if(empty($each->get_anh())){
                                                    echo "Null";
                                                }?>
                                                <img src="public/photos/khoahoc/<?php echo $each->get_anh()  ?>" alt="" height="100px">
                                            </td>
                                            <td>
                                                <button class="btn btn-info" data-toggle="modal" data-target="#maKhoaHoc<?php echo $each->get_maKhoaHoc() ?>">
                                                    Sửa
                                                </button>
                                            </td>
                                            <td>
                                                <a href="?action=delete&controller=khoahoc&maKhoaHoc=<?php echo $each->get_maKhoaHoc() ?>" class="btn btn-danger">
                                                    Xoá
                                                </a>
                                            </td>
                                        </tr>
