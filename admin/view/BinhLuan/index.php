                            ...
                            <div class="card">
                                ...
                                <div class="container">
                                    ...
                                    <?php foreach($arr as $each): ?>
                                        <tr>
                                            <td><?php echo $each->get_maBinhLuan() ?></td>
                                            ...
                                            <td><?php echo $each->get_noiDung() ?></td>
                                            <td><?php echo $each->get_ngayDang() ?></td>
                                           
                                            <td>
                                                <a href="?action=delete&controller=binhluan&maBinhLuan=<?php echo $each->get_maBinhLuan() ?>" class="btn btn-danger">
                                                    Xoá
                                                </a>
                                            </td>
                                        </tr>
